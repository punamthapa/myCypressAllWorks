...
describe("Test for task related to internal", function () {
    ...
    context("Add task dependent tests", function () {
        ...
        context(
            "Add task related to Internal and sort by 'Created Date' filter dependent test",
            function () {
                beforeEach(function () {
                    task_PO.clickOnCreateButton().sortByCreatedDate();
                });

                it("Should verify title, category, priority in list ,and title, description in drawer", function () {
                    task_PO
