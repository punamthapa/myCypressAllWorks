...
describe("Custom Fields setting client module", () => {
    ...
    context("Click on Add button dependent test", () => {
        ...
        it("Should verify the options of 'Section Name' dropdown in the drawer", () => {
            customFields_PO
        ...
        it("Should verify if 'Select Module' has 'Client' module selected and dropdown has 'Client', 'Partner', 'Product' and 'Application' options", () => {
            customFields_PO
