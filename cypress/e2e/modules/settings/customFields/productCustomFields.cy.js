...
describe("Custom Fields setting product module", () => {
    ...
    const productTab_PO = new CustomFieldsTabs_PO();
    ...
    beforeEach(() => {
        ...
        productTab_PO.clickOnProductTab();
    ...
    context("Click on Add button dependent test", () => {
        ...
        it("Should verify if 'Select Module' has 'Product' module selected and dropdown has 'Client', 'Partner', 'Product' and 'Application' options", () => {
            customFields_PO
